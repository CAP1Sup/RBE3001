...
title('Joint Angles Quintic Trajectory of a Triangle From Inverse Kinematics In Task Space')
xlabel('Time (s)')
ylabel('Pos (deg)')
...
title('X,Y,Z positions of EF In Task Space From Quintic Trajectory')
xlabel('Time (s)')
ylabel('Pos (mm)')
...
title('X,Y,Z velocities of EF in Task Space From Quintic Trajectory')
xlabel('Time (s)')
...
title('X,Y,Z accelerations of EF In Task Space From Quintic Trajectory')
xlabel('Time (s)')
ylabel('Accel (mm/s^2)')
